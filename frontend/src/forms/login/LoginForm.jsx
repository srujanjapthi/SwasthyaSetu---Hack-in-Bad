...
export default function LoginForm({
  ...
  return (
    <div
      className={`flex flex-col md:flex-row h-screen items-center justify-center transition-colors duration-300 ${
    ...
    >
      ...
      <div className="fixed inset-0 overflow-hidden opacity-10">
        <div
          className={`absolute rounded-full w-64 h-64 -top-32 -left-32 ${
            theme === "light" ? "bg-blue-200" : "bg-blue-900"
          }`}
        ></div>
        <div
          className={`absolute rounded-full w-96 h-96 -bottom-48 -right-48 ${
      ...
      >
        <Card
          className={`w-full max-w-md border-0 shadow-lg ${
            theme === "light"
              ? "bg-white"
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        ...
                        >
                          ...
                          <Input
                            className={`block w-full pl-10 pr-3 py-3 border-0 bg-transparent ${
                              theme === "light"
      ...
      >
        <div
          className={`rounded-3xl overflow-hidden shadow-2xl w-full h-full flex items-center justify-center ${
